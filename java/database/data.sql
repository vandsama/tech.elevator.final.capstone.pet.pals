...
INSERT INTO messages(
	message_id, topic_id, message_title, message_text)
	VALUES (1, 1, 'play with other dogs', 'Get your puppy outside and make sure they play with lots of other dogs so they can get used to different attitudes and behaviors.');
INSERT INTO messages(
	message_id, topic_id, message_title, message_text)
	VALUES (2, 3, 'are you sure it's mad at you?', 'sometimes I feel like my bearded dragon Stacy is mad at me but she's really just hungry for some flies.');
INSERT INTO messages(
	message_id, topic_id, message_title, message_text)
...
INSERT INTO messages(
	message_id, topic_id, message_title, message_text)
	VALUES (5, 1, 'play with other animals, and take them out often', 'make sure you play with them and introduce them to strangers and other animals. that way they will be used to the world around them');
INSERT INTO messages(
	message_id, topic_id, message_title, message_text)
	VALUES (6, 2, 'nah', 'nope you're the only one);
INSERT INTO messages(
	message_id, topic_id, message_title, message_text)
	VALUES (7, 3, 'what did you do', 'It must be mad at you for a reason. If you think really hard, you might be able to remember why it's upset at you! Then you can mend the bridge between you two.');
INSERT INTO messages(
	message_id, topic_id, message_title, message_text)
	VALUES (8, 1, 'why would you want to socialize them', 'I like my puppies not social');
INSERT INTO messages(
	message_id, topic_id, message_title, message_text)
	VALUES (9, 2, 'yeah actually it's so weird!', 'My cats do this too. They are such unique little fluff balls!');
INSERT INTO messages(
	message_id, topic_id, message_title, message_text)
	VALUES (10, 1, 'Train them while they're young!', 'You simply must train them while they are very very young to get the absolute best results possible.');
